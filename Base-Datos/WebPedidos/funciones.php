...
function entrefechas($conn,$fecha_ini,$fecha_fin){
    $stmtProductosfecha = $conn->prepare("SELECT products.productName from products, orderdetails, orders Where orders.orderNumber = orderdetails.orderNumber
    ...
    $productoFecha = $stmtProductosfecha->fetchALL(PDO::FETCH_COLUMN);
