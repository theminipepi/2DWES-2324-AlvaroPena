<?php
		...
		include_once '../controller/controller_movwelcome.php';
		include_once '../controller/controller_movdevolver.php';
		C_UserCookie();
   ?>
   <html>
  <head>
  ...
  <body>
    ...
    <h1 style='color:red'>VAYA, ALGO HA SALIDO MAL CON EL PAGO... vuelva a intentarlo</h1>
    <div class="container ">
        <!--Aplicacion-->
	...
	<form action="./controller_movdevolver.php" method="post">
	...
	<B>Bienvenido/a:</B><?php mostrarNombre($data); ?>  <BR><BR>
		<B>Identificador Cliente:</B><?php mostrarID($data); ?>   <BR><BR>
			...
			<?php AlquiladosDesplegable($Vehiculos); ?>
			</select>
		<BR><BR>
		<div>
