...
<html>
 ...
 <body>
	...
	<form action="../controllers/alquiler_controller.php" method="post">
			...
			<select name="vehiculos" class="form-control">
				<?php
            		...
            		foreach($vehiculos as $dato){
	                	echo "<option value='".$dato['matricula']." ".$dato['marca']." ".$dato['modelo']."'>".$dato['matricula']." ".$dato['marca']." ".$dato['modelo']."</option>";
            		}
        	?>
			</select>
