 ...
 <body>
    ...
    <div class="container ">
       ...
       <!--Formulario con botones -->
		...
		<input type="button" value="Consultar Alquileres" onclick="window.location.href='../views/movconsultar.php'" class="btn btn-warning disabled">
		<input type="button" value="Devolver Vehículo" onclick="window.location.href='../controllers/movdevolver_controllers.php'" class="btn btn-warning disabled">
		  ...
		  <BR><a href="../controllers/sesion_controllers.php">Cerrar Sesión</a>
	</div>      
   </body>
