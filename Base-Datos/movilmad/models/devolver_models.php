...
function disponibleVehiculo($matricula){
    $conexion = conexion();
    try {
	    $stmtDisponible = $conexion->prepare("UPDATE rvehiculos SET disponible = 'S' where matricula = :matricula");
        $stmtDisponible->bindParam(':matricula', $matricula);
