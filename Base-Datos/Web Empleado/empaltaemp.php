...
try {
    $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        ...
        $stmtEmple_Depart = $conn->prepare("INSERT INTO emple_depart (dni, cod_dpto, fecha_ini) VALUES (:dni, :cod_dpto, :fecha_ini)");
        $stmtEmple_Depart->bindParam(':dni', $dni);
        $stmtEmple_Depart->bindParam(':cod_dpto', $cod_dpto);
        $stmtEmple_Depart->bindParam(':fecha_ini', $fecha_ini);
