...
try {
    $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        ...
        $stmtEmpleados = $conn->prepare("SELECT empleado.nombre From emple_depart, empleado Where emple_depart.cod_dpto='$cod_dpto' and emple_depart.dni = empleado.dni and emple_depart.fecha_fin is null");
